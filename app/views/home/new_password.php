...
<head>
	...
	<link rel="stylesheet" href="<?php echo PUBLIC_FOLDER; ?>/css/new_password.css"/>
		...
		<div class="card offset-lg-2 col-lg-8">
			<div class="card-body">
				...
				<div class="col-md-12 px-5 py-4">
					<form action="<?php echo SERVER; ?>/home/new_password/token/<?php echo $token; ?>" method="POST" onsubmit="return validateData();">
